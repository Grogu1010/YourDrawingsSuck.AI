...
const GRID_SIZE = 16;
const ACTIVE_ALGORITHM_IDS = [1, 7, 45, 57, 64];
...
function runAlgorithms(vector, dataset) {
  if (!dataset.length) {
    return [
      ...
      { id: 64, name: "Algorithm 64 (Dev: RAES + explicit transform parity)", label: "Need training data first", confidence: 0 },
    ];
  }
  ...
  return [
    ...
    { id: 64, name: "Algorithm 64 (Dev: RAES + explicit transform parity)", label: algorithm64.label, confidence: algorithm64.confidence },
  ];
}
